...
var sixeBoxInput = document.querySelector('.sixeBoxInput');
var btnBars = document.querySelector('.button_1');
var boxDark = document.querySelector('.box_dark');
var btmMenuClosed = document.querySelector('.menuClosed');
...
btmMenuClosed.addEventListener('click', function () {
  if (btnBars.classList.contains('button_1_clicked')) {
    btnBars.classList.remove('button_1_clicked');
  } else {
    btnBars.classList.add('button_1_clicked');
